...
dependencies {
    ...
    compileOnly("dev.jorel.CommandAPI:commandapi-core:8.7.1")
    ...
    doLast {
        ssh.runSessions {
            session(adminssh) {
                ...
                execute("cd /home/epic/play/m14/server_config/plugins && rm -f MonumentaWorldManagement.jar && ln -s " + shadowJar.archiveFileName.get() + " MonumentaWorldManagement.jar")
